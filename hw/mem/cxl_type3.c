                                             ...
                                             Error **errp)
{
    ...
    while (list) {
        ...
        max_region_id = MAX(max_region_id, rid);
    ...
    blk_bitmap = bitmap_new((dcd->dc.regions[max_region_id].len +
                             dcd->dc.regions[max_region_id].base -
                             dcd->dc.regions[0].base) / min_block_size);
